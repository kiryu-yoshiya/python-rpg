...
credentials = ServiceAccountCredentials.from_json_keyfile_name('python-rpg20210306-6a50ea607116.json', scope)

#OAuth2の資格情報を使用してGoogle APIにログインします。
gc = gspread.authorize(credentials)

#共有設定したスプレッドシートキーを変数[SPREADSHEET_KEY]に格納する。
SPREADSHEET_KEY = '1Bw9iZ1ONc4ATvKubpuam-sNoCIgTMYvY2ycx_ssGsKY'
